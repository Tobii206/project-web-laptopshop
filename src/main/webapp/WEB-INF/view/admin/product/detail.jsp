                ...
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active"><a style="text-decoration: none;"
                                ...
                                href="/admin/product">Sản phẩm</a>
                        </li>
                    </ol>
                    <div class="mt-5">
                        <div class="d-flex justify-content-between">
                            <h3>Chi tiết sản phẩm ${id}</h3>
                            <a href="http://localhost:8080/admin/product" class="btn btn-primary">Quay lại</a>
                        </div>
                        <hr />
                        <div class="card">
                                ...
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>${product.displayShortDesc}</td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Chi tiếtDesc:</th>
                                            <td>${product.displayDetailDesc}</td>
                                        </tr>
                                        <tr>
                                            <th scope="row">So luong:</th>
                                        ...
                                        <tr>
                                            <th scope="row">Nhu cau:</th>
                                            <td>${product.displayTarget}</td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Hinh anh:</th>
